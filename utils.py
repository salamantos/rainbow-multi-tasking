...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        # set advantage layer
        self.advantage_hidden_layer = NoisyLinear(self.hidden_size, self.second_size)
        self.advantage_layer = NoisyLinear(self.second_size, out_dim * atom_size)  # output one distribution per action
        # set value layer
        self.value_hidden_layer = NoisyLinear(self.hidden_size, self.second_size)
        self.value_layer = NoisyLinear(self.second_size, atom_size)
